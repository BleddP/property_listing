    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured', models.BooleanField(default=False)),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='selling_agent', to='rest_api.agent')),
                ('area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.area')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.city')),
            ],
        ),
        migrations.CreateModel(
            name='PropertyType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blacklisted', models.BooleanField(default=False)),
                ('saved_agents', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='agent_history', to='rest_api.agent')),
                ('saved_properties', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='saved_properties', to='rest_api.property')),
                ('viewed_properties', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='property_history', to='rest_api.property')),
            ],
        ),
        migrations.CreateModel(
            name='Station',
            fields=[
                ...
                ('area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.area')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.city')),
                ('nearby_agents', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='area_agents', to='rest_api.agent')),
                ('nearby_properties', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='area_properties', to='rest_api.property')),
            ],
        ),
        migrations.CreateModel(
            name='School',
            fields=[
                ...
                ('area', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.area')),
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.city')),
                ('nearby_agents', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='school_area_agents', to='rest_api.agent')),
                ('nearby_properties', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='school_area_properties', to='rest_api.property')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured', models.BooleanField(default=False)),
                ('industry_affiliations', models.CharField(blank=True, max_length=30)),
                ('account_manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.accountmanager')),
                ('agents', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.agent')),
                ('properties', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rest_api.property')),
            ],
        ),
        migrations.AddField(
            model_name='property',
            name='nearby_schools',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='school_area', to='rest_api.school'),
        ),
        migrations.AddField(
            model_name='property',
            name='nearby_stations',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='station_area', to='rest_api.station'),
        ),
        migrations.AddField(
            model_name='property',
            name='property_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='property_type', to='rest_api.propertytype'),
        ),
        migrations.AddField(
            model_name='city',
            name='agencies',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='city_agencies', to='rest_api.realestateagency'),
        ),
        migrations.AddField(
            model_name='city',
            name='properties',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='city_properties', to='rest_api.property'),
        ),
        migrations.AddField(
            model_name='area',
            name='city',
        ...
        migrations.AddField(
            model_name='area',
            name='nearby_agents',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhood_agencies', to='rest_api.agent'),
        ),
        migrations.AddField(
            model_name='area',
            name='nearby_properties',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhood_properties', to='rest_api.property'),
        ),
        migrations.AddField(
            model_name='area',
            name='nearby_schools',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhood_schools', to='rest_api.school'),
        ),
        migrations.AddField(
            model_name='area',
            name='nearby_stations',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='neighbourhood_stations', to='rest_api.station'),
        ),
        migrations.AddField(
            model_name='agent',
            name='agency',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rest_api.realestateagency'),
        ),
        migrations.AddField(
            model_name='agent',
            name='area',
        ...
        migrations.AddField(
            model_name='agent',
            name='properties',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='agencies', to='rest_api.property'),
        ),
    ]
